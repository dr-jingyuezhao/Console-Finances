...
// declare greatest profit variables
var greatestInDate;
...
// find the dates for greatest profit increase/decrease in the finances array
var x = allProfitChange.indexOf(greatestInProfit);
var y = allProfitChange.indexOf(greatestDeProfit);
greatestInDate = finances[x+1][0];
greatestDeDate = finances[y+1][0];

// print the final analysis to the console using the given format
// display the title of financial analysis
